const ptBR = {
  ...
  entities: {
    property: {
        ...
        label: 'Properties',
        menu: 'Properties',
        exporterFileName: 'Property_exportados',
        list: {
          menu: 'Properties',
          title: 'Properties',
        },
        create: {
          success: 'Property salvo com sucesso',
        },
        update: {
          success: 'Property salvo com sucesso',
        },
        destroy: {
          success: 'Property deletado com sucesso',
        },
        destroyAll: {
          success: 'Property(s) deletado com sucesso',
        },
        edit: {
        ...
        view: {
          title: 'Visualizar Property',
        },
        importer: {
          title: 'Importar Properties',
          fileName: 'property_template_importacao',
          hint:
    ...
    resident: {
        ...
        label: 'Residents',
        menu: 'Residents',
        exporterFileName: 'Resident_exportados',
        list: {
          menu: 'Residents',
          title: 'Residents',
        },
        create: {
          success: 'Resident salvo com sucesso',
        },
        update: {
          success: 'Resident salvo com sucesso',
        },
        destroy: {
          success: 'Resident deletado com sucesso',
        },
        destroyAll: {
          success: 'Resident(s) deletado com sucesso',
        },
        edit: {
          title: 'Editar Resident',
        },
        fields: {
          id: 'Id',
    ...
    maintenanceRequest: {
        ...
        exporterFileName: 'Maintenance Request_exportados',
        list: {
          menu: 'MaintenanceRequests',
          title: 'MaintenanceRequests',
        },
        create: {
          success: 'Maintenance Request salvo com sucesso',
        },
        update: {
          success: 'Maintenance Request salvo com sucesso',
        },
        destroy: {
          success: 'Maintenance Request deletado com sucesso',
        },
        destroyAll: {
          success: 'Maintenance Request(s) deletado com sucesso',
        },
        edit: {
          title: 'Editar Maintenance Request',
        },
        fields: {
          id: 'Id',
          'title': 'Title',
        ...
        new: {
          title: 'Novo Maintenance Request',
        },
        view: {
          title: 'Visualizar Maintenance Request',
        },
        importer: {
