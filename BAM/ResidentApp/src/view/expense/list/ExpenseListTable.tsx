            ...
            <tr>
              <TableColumnHeader className="th-checkbox">
                ...
                <TableColumnHeader
                  ...
                  name={'category'}
                  label={i18n(
                    'entities.expense.fields.category',
                  )}
                />
                <TableColumnHeader
                  onSort={doChangeSort}
                  ...
                  name={'amount'}
                  label={i18n(
                    'entities.expense.fields.amount',
                  )}
                  align="right"
                />
                <TableColumnHeader
                  label={i18n(
                    'entities.expense.fields.property',
                  )}
                />
                <TableColumnHeader
                  onSort={doChangeSort}
                  ...
                  name={'payDate'}
                  label={i18n(
                    'entities.expense.fields.payDate',
                  )}
                />
                <TableColumnHeader
                  onSort={doChangeSort}
                  ...
                  name={'vendor'}
                  label={i18n(
                    'entities.expense.fields.vendor',
                  )}
                />
              ...
              rows.map((row) => (
                <tr key={row.id}>
                  ...
                  <td>
                    {row.category
                      ? i18n(
                          `entities.expense.enumerators.category.${row.category}`,
                        )
                      : null}
                  </td>
