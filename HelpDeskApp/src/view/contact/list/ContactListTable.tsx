...
function ContactListTable(props) {
  ...
  const hasPermissionToEdit = useSelector(
    contactSelectors.selectPermissionToEdit,
  );
            ...
            <tr>
              <TableColumnHeader className="th-checkbox">
                ...
                <TableColumnHeader
                  ...
                  name={'birthdate'}
                  label={i18n(
                    'entities.contact.fields.birthdate',
                  )}
                />
                <TableColumnHeader
                  onSort={doChangeSort}
                  ...
                  name={'gender'}
                  label={i18n(
                    'entities.contact.fields.gender',
                  )}
                />
                <TableColumnHeader
                  onSort={doChangeSort}
                ...
                <TableColumnHeader
                  ...
                  name={'company'}
                  label={i18n(
                    'entities.contact.fields.company',
                  )}
                />
                <TableColumnHeader
                  onSort={doChangeSort}
                ...
                <TableColumnHeader
                  ...
                  name={'phoneNumber'}
                  label={i18n(
                    'entities.contact.fields.phoneNumber',
                  )}
                />
              ...
              rows.map((row) => (
                <tr key={row.id}>
                  ...
                  <td>
                    {row.gender
                      ? i18n(
                          `entities.contact.enumerators.gender.${row.gender}`,
                        )
                      : null}
                  </td>
                  <td>{row.title}</td>
