const es = {
  ...
  entities: {
    contact: {
        ...
        label: 'Contacts',
        menu: 'Contacts',
        exporterFileName: 'exportacion_contact',
        list: {
          menu: 'Contacts',
          title: 'Contacts',
        },
        create: {
          success: 'Contact guardado con éxito',
        },
        update: {
          success: 'Contact guardado con éxito',
        },
        destroy: {
          success: 'Contact eliminado con éxito',
        },
        destroyAll: {
    ...
    ticket: {
        ...
        label: 'Tickets',
        menu: 'Tickets',
        exporterFileName: 'exportacion_ticket',
        list: {
          menu: 'Tickets',
          title: 'Tickets',
        },
        create: {
          success: 'Ticket guardado con éxito',
        },
        update: {
          success: 'Ticket guardado con éxito',
        },
        destroy: {
          success: 'Ticket eliminado con éxito',
        },
        destroyAll: {
          success: 'Ticket(s) eliminado con éxito',
        },
        edit: {
          title: 'Editar Ticket',
        },
        ...
        importer: {
          ...
          fileName: 'ticket_import_template',
          hint:
            'Las columnas Archivos/Imágenes deben ser las URL de los archivos separados por espacio.',
        },
      },
