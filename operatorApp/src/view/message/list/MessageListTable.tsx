            ...
            <tr>
              <TableColumnHeader className="th-checkbox">
                ...
                <TableColumnHeader
                  ...
                  name={'description'}
                  label={i18n(
                    'entities.message.fields.description',
                  )}
                />
                <TableColumnHeader
                  onSort={doChangeSort}
                  ...
                  name={'messageStatus'}
                  label={i18n(
                    'entities.message.fields.messageStatus',
                  )}
                />
                <TableColumnHeader
                  label={i18n(
                    'entities.message.fields.assignee',
                  )}
                />
              ...
              rows.map((row) => (
                <tr key={row.id}>
                  ...
                  <td>
                    {row.messageStatus
                      ? i18n(
                          `entities.message.enumerators.messageStatus.${row.messageStatus}`,
                        )
                      : null}
                  </td>
                  <td>
