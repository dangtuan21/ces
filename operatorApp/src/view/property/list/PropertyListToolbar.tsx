...
function PropertyToolbar(props) {
  ...
  const hasPermissionToImport = useSelector(
    propertySelectors.selectPermissionToImport,
  );
    ...
    if (disabled) {
      return (
        <span
          ...
          data-for="property-list-toolbar-export-tooltip"
        >
          {button}
          <ReactTooltip id="property-list-toolbar-export-tooltip" />
        </span>
      );
    }
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tip-disable={!disabled}
          data-for="property-list-toolbar-destroy-tooltip"
        >
          {button}
          <ReactTooltip id="property-list-toolbar-destroy-tooltip" />
        </span>
      );
    }
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=property">
