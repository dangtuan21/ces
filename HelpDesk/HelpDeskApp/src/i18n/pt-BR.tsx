const ptBR = {
  ...
  entities: {
    contact: {
        ...
        label: 'Contacts',
        menu: 'Contacts',
        exporterFileName: 'Contact_exportados',
        list: {
          menu: 'Contacts',
          title: 'Contacts',
        },
        create: {
          success: 'Contact salvo com sucesso',
        },
        update: {
          success: 'Contact salvo com sucesso',
        },
        destroy: {
          success: 'Contact deletado com sucesso',
        },
        destroyAll: {
          success: 'Contact(s) deletado com sucesso',
        },
        edit: {
          title: 'Editar Contact',
        },
        fields: {
          id: 'Id',
          'name': 'Name',
        ...
        view: {
          title: 'Visualizar Contact',
        },
        importer: {
          title: 'Importar Contacts',
          fileName: 'contact_template_importacao',
          hint:
    ...
    ticket: {
        ...
        label: 'Tickets',
        menu: 'Tickets',
        exporterFileName: 'Ticket_exportados',
        list: {
          menu: 'Tickets',
          title: 'Tickets',
        },
        create: {
          success: 'Ticket salvo com sucesso',
        },
        update: {
          success: 'Ticket salvo com sucesso',
        },
        ...
        destroyAll: {
          success: 'Ticket(s) deletado com sucesso',
        },
        edit: {
          title: 'Editar Ticket',
        },
        ...
        importer: {
          ...
          fileName: 'ticket_template_importacao',
          hint:
            'Arquivos/Imagens devem ser as URLs dos arquivos, separados por espaço. Relacionamentos devem ser os IDs separados por espaço.',
        },
      },
