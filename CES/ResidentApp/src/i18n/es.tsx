const es = {
  ...
  entities: {
    property: {
        ...
        label: 'Properties',
        menu: 'Properties',
        exporterFileName: 'exportacion_property',
        list: {
          menu: 'Properties',
          title: 'Properties',
        },
        create: {
          success: 'Property guardado con éxito',
        },
        update: {
          success: 'Property guardado con éxito',
        },
        destroy: {
          success: 'Property eliminado con éxito',
        },
        destroyAll: {
          success: 'Property(s) eliminado con éxito',
        },
        edit: {
    ...
    resident: {
        ...
        label: 'Residents',
        menu: 'Residents',
        exporterFileName: 'exportacion_resident',
        list: {
          menu: 'Residents',
          title: 'Residents',
        },
        create: {
          success: 'Resident guardado con éxito',
        },
        update: {
          success: 'Resident guardado con éxito',
        },
        destroy: {
          success: 'Resident eliminado con éxito',
        },
        destroyAll: {
          success: 'Resident(s) eliminado con éxito',
        },
        edit: {
    ...
    maintenanceRequest: {
        ...
        exporterFileName: 'exportacion_maintenanceRequest',
        list: {
          menu: 'MaintenanceRequests',
          title: 'MaintenanceRequests',
        },
        create: {
          success: 'Maintenance Request guardado con éxito',
        },
        update: {
          success: 'Maintenance Request guardado con éxito',
        },
        destroy: {
          success: 'Maintenance Request eliminado con éxito',
        },
        destroyAll: {
          success: 'Maintenance Request(s) eliminado con éxito',
        },
        edit: {
        ...
        new: {
          title: 'Nuevo Maintenance Request',
        },
        view: {
          title: 'Ver Maintenance Request',
        },
        importer: {
